        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h2 className="text-base font-bold text-gray-900">{formatWeekRange(weekStart)}</h2>
              <div className="mt-1 text-xs text-gray-500">{stats.daysLogged}/7 days logged</div>
              <div className="mt-0.5 text-xs text-gray-400">Updates at end of day</div>
              {!isCurrentWeek() && (
                <button
        ...
        {stats.daysLogged === 0 ? (
          <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 text-center">
            ...
            <p className="text-xs text-gray-500">
              Start logging food to see your weekly stats here
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div
                className={`${deficitBgColor} rounded-xl border border-gray-200 p-4 shadow-sm hover:border-gray-300 transition-all`}
              >
                ...
                <p className={`text-sm font-medium ${deficitColor} leading-relaxed`}>
                  You are in an average{' '}
                  <span className="font-bold">
                    {isDeficit ? 'deficit' : isSurplus ? 'surplus' : 'maintenance'}
                  </span>{' '}
                  of <span className="font-bold text-base">{dailyValue}</span> cal/day
                </p>
              </div>

              {/* Weekly Deficit/Surplus */}
              <div
                className={`${weeklyDeficitBgColor} rounded-xl border border-gray-200 p-4 shadow-sm hover:border-gray-300 transition-all`}
              >
                ...
                <p className={`text-sm font-medium ${weeklyDeficitColor} leading-relaxed`}>
                  ...
                  of <span className="font-bold text-base">{weeklyValue}</span> cal
                </p>
              </div>
            </div>
