      ...
      {entries.length === 0 ? (
        ...
        <div className="space-y-2.5">
          {entries.map((entry) => (
            <div
              key={entry.id}
              className="group bg-white/70 backdrop-blur-sm border border-gray-200 rounded-xl p-3 hover:border-gray-300 transition-all shadow-sm"
            >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    <span className="text-gray-900 font-medium">
                      {entry.calories} <span className="text-gray-500 font-normal">cal</span>
                    </span>
                    <span className="text-gray-900 font-medium">
                      {entry.protein}g <span className="text-gray-500 font-normal">pro</span>
                    </span>
                  </div>
                </div>
              </div>
