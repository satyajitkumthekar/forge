          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="text-left py-2.5 px-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                  Food
                </th>
                <th className="text-center py-2.5 px-2 text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
                  Cal
                </th>
                <th className="text-center py-2.5 px-2 text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">
                  Pro
